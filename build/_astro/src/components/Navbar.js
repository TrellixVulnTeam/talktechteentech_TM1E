...
function a() {
  ...
  return t.createElement(
    ...
    t.createElement(
      "div",
      { className: "xl:max-w-6xl mx-auto py-7 px-6" },
      t.createElement(
        "div",
        ...
        t.createElement(
          ...
          {
            className:
              "hidden md:flex items-center text-white font-main text-2xl justify-between space-x-10",
          },
          i.map((e) =>
            t.createElement(
              "div",
              null,
              t.createElement("a", { className: n, href: e.href }, e.name)
            )
          )
        ),
        t.createElement(
          ...
          t.createElement(
            "button",
            { className: "bg-white px-5 py-1.5" },
            t.createElement(
              "span",
              {
                className:
                  "text-transparent font-bold text-2xl font-main bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400",
              },
              "Log In"
            )
          )
    ...
    t.createElement(
      ...
      i.map((e) =>
        t.createElement(
          ...
          t.createElement(
            "a",
            { className: "hover:underline", href: e.href },
            e.name
          )
        )
      )
